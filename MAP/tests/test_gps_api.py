...
class GpsApiIntegrationTest(unittest.TestCase):
    ...
    def test_video_screen_is_explicit_demo_and_uses_konkuk_pois(self) -> None:
        ...
        self.assertIn("readoutCurrentCoordinate", html)
        self.assertIn("readoutTargetCoordinate", html)
        ...
        self.assertIn("해가 지기까지 1시간 남았습니다. Base Camp로 돌아가세요.", video_app)
        ...
        self.assertIn("현재 위도", video_app)
        self.assertIn("경도", video_app)
