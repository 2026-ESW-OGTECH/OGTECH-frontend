...
| **ENVIRONMENT** | 기온·습도. STM32 상시 계층에서 올라온 값입니다 |
| **CO 농도** | 일산화탄소 ppm. `DEMO` 배지가 모의 값임을 숨기지 않습니다 |
...
- **예상 도착 시각과 남은 시간** — 최근 보행 속도로 역산합니다
...
- **모의 값이 하나라도 섞이면 `DEMO` 배지를 숨기지 않습니다.** 위 캡처의 CO 값이 그 예입니다.
