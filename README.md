...
구현 상태는 [조직 PLAN](https://github.com/2026-ESCW-OGTECH/.github/blob/main/PLAN.md)과 저장소 이슈에서 관리합니다.
...
실행 경로와 현재 UI의 제한 사항은 [AGENTS.md](https://github.com/2026-ESCW-OGTECH/.github/blob/main/AGENTS.md)를 따릅니다.
